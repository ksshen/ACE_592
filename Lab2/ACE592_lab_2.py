# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 21:07:58 2019
    ...
    def on_data(self, data):
        ...
        if (time.time() - self.start_time) < self.limit:
            ...
            if( geo_flag == 1 ):
                ...
                if '#dog' in text:
                  print( 'catch data with coordinates and #dog' )
...
if __name__ == '__main__':
    ...
    # I cannot get the same result by only using track=['dog'], so I add the filter condition in above section
    stream.filter(track=['#dog'], locations=[-74.25,40.91,-73.70,40.49])
                         
                         
                         
# We want to open the location of the csv file we just saved
with open(os.path.join(os.path.expanduser('~'), "outputs/Lab2/Twitter_Data.csv")) as csvfile:
